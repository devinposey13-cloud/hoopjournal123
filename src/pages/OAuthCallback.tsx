 ...
 * Works for:
 * 1. Web (lovable.app / custom domain) - parses tokens from URL, sets session, redirects to /
 * 2. Native Capacitor app - receives tokens via deep link, sets session, redirects to /
 */
