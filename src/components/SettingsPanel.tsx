...
import { Save, Loader2, Crown, CreditCard, Sun, Moon, Monitor, Trophy, ChevronRight, Star, User, Check, XCircle, Shield, FileText, Lock, Mail, KeyRound } from 'lucide-react';
