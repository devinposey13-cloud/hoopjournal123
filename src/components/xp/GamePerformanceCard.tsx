...
import { TrendingUp, Zap, Award, Star } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { cn } from '@/lib/utils';
import { calculatePerformance, getTierDisplayName, getTierColorClass, getTierGradient } from '@/utils/performanceScoring';
