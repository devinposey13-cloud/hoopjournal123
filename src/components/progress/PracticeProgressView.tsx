...
import { Target, Trophy, TrendingUp, TrendingDown, Percent, Circle, Flame } from 'lucide-react';
...
export function PracticeProgressView({ sessions, games = [], mode }: PracticeProgressViewProps) {
    ...
    return (
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-16">
          ...
          <p className="text-muted-foreground">Log practice sessions to see your shooting trends</p>
        </CardContent>
      </Card>
    );
  }
